...
class TBeautifulCapiParams(object):
    def __init__(self):
        ...
        self.m_folder_per_namespace_filled = False
        self.m_file_per_class = True
        self.m_file_per_class_filled = False
        self.m_namespace_header_at_parent_folder = True
        self.m_namespace_header_at_parent_folder_filled = False
        self.m_generate_single_file = False
        self.m_generate_single_file_filled = False
        self.m_single_header_name = "Output.h"
        self.m_single_header_name_filled = False
        self.m_dynamically_load_functions = False
        self.m_dynamically_load_functions_filled = False
        self.m_capi_header_suffix = "Capi"
        self.m_capi_header_suffix_filled = False
        self.m_fwd_header_suffix = "Fwd"
        self.m_fwd_header_suffix_filled = False
        self.m_wrapper_class_suffix_copy_semantic = ""
        self.m_wrapper_class_suffix_copy_semantic_filled = False
        self.m_wrapper_class_suffix_reference_counted = "Ptr"
        self.m_wrapper_class_suffix_reference_counted_filled = False
        self.m_wrapper_class_suffix_raw_pointer = "RawPtr"
        self.m_wrapper_class_suffix_raw_pointer_filled = False
        self.m_forward_typedef_suffix = "FwdPtr"
        self.m_forward_typedef_suffix_filled = False
        self.m_is_null_method = "IsNull"
        self.m_is_null_method_filled = False
        self.m_is_not_null_method = "IsNotNull"
        self.m_is_not_null_method_filled = False
        self.m_delete_method = "Delete"
        self.m_delete_method_filled = False
        self.m_forward_holder_filename = "beautiful_capi/forward_holder.h"
        self.m_forward_holder_filename_filled = False
        self.m_check_and_throw_exception_filename = "beautiful_capi/check_and_throw_exception.h"
        self.m_check_and_throw_exception_filename_filled = False
        self.m_exception_handling_mode = TExceptionHandlingMode.no_handling
        self.m_exception_handling_mode_filled = False
        self.m_custom_callbacks_filename = "beautiful_capi/custom_callbacks.h"
        self.m_custom_callbacks_filename_filled = False
        self.m_copyright_header = ""
        self.m_copyright_header_filled = False
        self.m_automatic_generated_warning = ""
        self.m_automatic_generated_warning_filled = False
    ...
    def load(self, dom_node):
        ...
        if dom_node.hasAttribute("folder_per_namespace"):
            ...
            self.m_folder_per_namespace_filled = True
        if dom_node.hasAttribute("file_per_class"):
            ...
            self.m_file_per_class_filled = True
        if dom_node.hasAttribute("namespace_header_at_parent_folder"):
            ...
            self.m_namespace_header_at_parent_folder_filled = True
        if dom_node.hasAttribute("generate_single_file"):
            ...
            self.m_generate_single_file_filled = True
        if dom_node.hasAttribute("single_header_name"):
            ...
            self.m_single_header_name_filled = True
        if dom_node.hasAttribute("dynamically_load_functions"):
            ...
            self.m_dynamically_load_functions_filled = True
        if dom_node.hasAttribute("capi_header_suffix"):
            ...
            self.m_capi_header_suffix_filled = True
        if dom_node.hasAttribute("fwd_header_suffix"):
            ...
            self.m_fwd_header_suffix_filled = True
        if dom_node.hasAttribute("wrapper_class_suffix_copy_semantic"):
            ...
            self.m_wrapper_class_suffix_copy_semantic_filled = True
        if dom_node.hasAttribute("wrapper_class_suffix_reference_counted"):
            ...
            self.m_wrapper_class_suffix_reference_counted_filled = True
        if dom_node.hasAttribute("wrapper_class_suffix_raw_pointer"):
            ...
            self.m_wrapper_class_suffix_raw_pointer_filled = True
        ...
        if dom_node.hasAttribute("forward_holder_filename"):
            ...
            self.m_forward_holder_filename_filled = True
        if dom_node.hasAttribute("check_and_throw_exception_filename"):
            ...
            self.m_check_and_throw_exception_filename_filled = True
        if dom_node.hasAttribute("exception_handling_mode"):
            ...
            self.m_exception_handling_mode_filled = True
        if dom_node.hasAttribute("custom_callbacks_filename"):
            cur_attr = dom_node.getAttribute("custom_callbacks_filename")
            self.m_custom_callbacks_filename = cur_attr
            self.m_custom_callbacks_filename_filled = True
