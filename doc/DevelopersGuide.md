...
could be executable files, static libraries and shared libraries. The clients could be written in either pure
...
The wrapped C++ library API is described in a portable XML format for the exposed API
