...
namespace Example
{
    public class ICircle : Example.IShape
    {
        private global::System.Runtime.InteropServices.HandleRef capi_ptr;
        
        internal ICircle(global::System.IntPtr c_ptr, bool owned) : base(DownCastPINVOKE.Invoke_example_icircle_cast_to_base(c_ptr), owned)
        {
            capi_ptr = new global::System.Runtime.InteropServices.HandleRef(this, c_ptr);
        }
        
        internal static global::System.Runtime.InteropServices.HandleRef getCPtr(ICircle obj)
        {
        ...
        public override void Dispose()
        {
            lock(this)
            {
                if (capi_ptr.Handle != global::System.IntPtr.Zero)
                {
                    ...
                    {
                        capi_owned = false;
                        DownCastPINVOKE.Invoke_example_icircle_release(capi_ptr);
                    }
