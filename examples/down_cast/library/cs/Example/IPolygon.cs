...
namespace Example
{
    public class IPolygon : Example.IShape
    {
        private global::System.Runtime.InteropServices.HandleRef capi_ptr;
        
        internal IPolygon(global::System.IntPtr c_ptr, bool owned) : base(DownCastPINVOKE.Invoke_example_ipolygon_cast_to_base(c_ptr), owned)
        {
            capi_ptr = new global::System.Runtime.InteropServices.HandleRef(this, c_ptr);
        }
        
        internal static global::System.Runtime.InteropServices.HandleRef getCPtr(IPolygon obj)
        {
        ...
        public override void Dispose()
        {
            lock(this)
            {
                if (capi_ptr.Handle != global::System.IntPtr.Zero)
                {
                    ...
                    {
                        capi_owned = false;
                        DownCastPINVOKE.Invoke_example_ipolygon_release(capi_ptr);
                    }
