...
#ifndef BEAUTIFUL_CAPI_DOXYGEN_DOC_NAME_H
#define BEAUTIFUL_CAPI_DOXYGEN_DOC_NAME_H
...
namespace DoxygenDoc
{
    ...
    public:
        NameImpl(const char* first_name, const char* last_name) 
        {
...
#endif /* BEAUTIFUL_CAPI_DOXYGEN_DOC_NAME_H */
