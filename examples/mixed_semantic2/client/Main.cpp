...
int main()
{
    ...
    std::cout << "street name (ref) = " << address_ref->GetStreetName() << std::endl;
    std::cout << "street name (raw) = " << address_raw->GetStreetName() << std::endl;
    std::cout << "street name (cop) = " << address_copy.GetStreetName() << std::endl;
...
//
//    MixedSemantic2::Name name("default", "default", "default");    
////    MixedSemantic2::NameRawPtr custom_name("Jon", "Edward", "Snow");  
////    name = custom_name;
//    printer.Show(name);
//    printer.ShowByPointer(name);
//    printer.ShowByReference(name);
//
//    MixedSemantic2::PersonCopy person;
//    person.SetName(name);
//    person.SetDay(27);
//    person.SetMonth(12);
//    person.SetYear(324);
...
//
//    MixedSemantic2::AddressCopy address;
...
//    MixedSemantic2::Mutator mutator;
//    mutator.Mutate(name);
