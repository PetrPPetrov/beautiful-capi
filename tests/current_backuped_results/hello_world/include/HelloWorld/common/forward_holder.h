...
#ifndef BEAUTIFUL_CAPI_HELLOWORLD_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_HELLOWORLD_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_HelloWorld
{
...
#endif /* BEAUTIFUL_CAPI_HELLOWORLD_FORWARD_HOLDER_INCLUDED */
