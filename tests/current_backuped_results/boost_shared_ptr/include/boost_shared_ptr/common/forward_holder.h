...
#ifndef BEAUTIFUL_CAPI_BOOST_SHARED_PTR_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_BOOST_SHARED_PTR_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_boost_shared_ptr
{
...
#endif /* BEAUTIFUL_CAPI_BOOST_SHARED_PTR_FORWARD_HOLDER_INCLUDED */
