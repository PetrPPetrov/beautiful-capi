...
#ifndef EXAMPLE_PRINTERSHAREDPTR_DECLARATION_INCLUDED
#define EXAMPLE_PRINTERSHAREDPTR_DECLARATION_INCLUDED
...
#endif /* EXAMPLE_PRINTERSHAREDPTR_DECLARATION_INCLUDED */
