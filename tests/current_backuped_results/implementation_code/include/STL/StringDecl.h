...
#ifndef STL_STRING_DECLARATION_INCLUDED
#define STL_STRING_DECLARATION_INCLUDED
...
public:
    ...
    inline String(ECreateFromRawPointer, void *object_pointer, bool copy_object);
    inline ~String();
    inline String& operator=(const String& other);
    #ifdef STL_CPP_COMPILER_HAS_RVALUE_REFERENCES
    inline String& operator=(String&& other);
    #endif /* STL_CPP_COMPILER_HAS_RVALUE_REFERENCES */
    static inline String Null();
...
#endif /* STL_STRING_DECLARATION_INCLUDED */
