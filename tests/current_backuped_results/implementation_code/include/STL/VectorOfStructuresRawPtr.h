...
#ifndef STL_VECTOROFSTRUCTURESRAWPTR_DEFINITION_INCLUDED
#define STL_VECTOROFSTRUCTURESRAWPTR_DEFINITION_INCLUDED

#include "STL/VectorOfStructuresRawPtrDecl.h"
...
inline STL::VectorOfStructuresRawPtr::VectorOfStructuresRawPtr()
{
    ...
    STL::VectorOfStructuresRawPtr result(STL::VectorOfStructuresRawPtr::force_creating_from_raw_pointer, stl_vector_of_structures_raw_ptr_default(&exception_info), false);
...
{
    beautiful_capi_implementationcode_exception_info_t exception_info;
    size_t result(stl_vector_of_structures_raw_ptr_get_size_const(&exception_info, GetRawPointer()));
    beautiful_capi_ImplementationCode::check_and_throw_exception(exception_info.code, exception_info.object_pointer);
    return result;
}
...
{
    beautiful_capi_implementationcode_exception_info_t exception_info;
    STL::Person result(STL::Person::force_creating_from_raw_pointer, stl_vector_of_structures_raw_ptr_get_element_const(&exception_info, GetRawPointer(), index), false);
    beautiful_capi_ImplementationCode::check_and_throw_exception(exception_info.code, exception_info.object_pointer);
    return result;
}
...
{
    beautiful_capi_implementationcode_exception_info_t exception_info;
    stl_vector_of_structures_raw_ptr_set_element(&exception_info, GetRawPointer(), index, value.GetRawPointer());
    beautiful_capi_ImplementationCode::check_and_throw_exception(exception_info.code, exception_info.object_pointer);
}
...
{
    beautiful_capi_implementationcode_exception_info_t exception_info;
    stl_vector_of_structures_raw_ptr_push_back(&exception_info, GetRawPointer(), value.GetRawPointer());
    beautiful_capi_ImplementationCode::check_and_throw_exception(exception_info.code, exception_info.object_pointer);
}
...
inline void STL::VectorOfStructuresRawPtr::Delete()
{
    if (GetRawPointer())
    {
        stl_vector_of_structures_raw_ptr_delete(GetRawPointer());
        SetObject(0);
    }
}
...
#endif /* STL_VECTOROFSTRUCTURESRAWPTR_DEFINITION_INCLUDED */
