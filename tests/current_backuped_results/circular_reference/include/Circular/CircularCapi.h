...
#define CIRCULAR_PATCH_VERSION 0
    ...
    typedef void (CIRCULAR_API_CONVENTION *circular_class_b_delete_function_type)(void* object_pointer);
        ...
        #else
            circular_class_a_delete_function_type circular_class_a_delete = 0;
        #endif
        #ifdef circular_class_b_default_define_function_pointer_var
            circular_class_b_default_define_function_pointer_var
        #else
            circular_class_b_default_function_type circular_class_b_default = 0;
        #endif
        ...
        #else
            circular_class_b_delete_function_type circular_class_b_delete = 0;
        #endif
