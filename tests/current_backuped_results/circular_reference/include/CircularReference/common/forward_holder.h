...
#ifndef BEAUTIFUL_CAPI_CIRCULARREFERENCE_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_CIRCULARREFERENCE_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_CircularReference
{
...
#endif /* BEAUTIFUL_CAPI_CIRCULARREFERENCE_FORWARD_HOLDER_INCLUDED */
