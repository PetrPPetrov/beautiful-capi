...
#define EXCEPTION_PATCH_VERSION 0
    ...
    typedef void* (EXCEPTION_API_CONVENTION *exception_division_by_zero_cast_to_base_function_type)(void* object_pointer);
        ...
        #else
            exception_generic_copy_function_type exception_generic_copy = 0;
        #endif
        #ifdef exception_generic_delete_define_function_pointer_var
            exception_generic_delete_define_function_pointer_var
        #else
            exception_generic_delete_function_type exception_generic_delete = 0;
        #endif
        ...
        #else
            exception_bad_argument_copy_function_type exception_bad_argument_copy = 0;
        #endif
        #ifdef exception_bad_argument_delete_define_function_pointer_var
            exception_bad_argument_delete_define_function_pointer_var
        #else
            exception_bad_argument_delete_function_type exception_bad_argument_delete = 0;
        #endif
        ...
        #else
            exception_null_argument_delete_function_type exception_null_argument_delete = 0;
        #endif
        ...
        #else
            exception_null_argument_cast_to_base_function_type exception_null_argument_cast_to_base = 0;
        #endif
        ...
        #else
            exception_division_by_zero_new_function_type exception_division_by_zero_new = 0;
        #endif
        ...
        #else
            exception_division_by_zero_copy_function_type exception_division_by_zero_copy = 0;
        #endif
        ...
        #else
            exception_division_by_zero_delete_function_type exception_division_by_zero_delete = 0;
        #endif
        ...
        #else
            exception_division_by_zero_cast_to_base_function_type exception_division_by_zero_cast_to_base = 0;
        #endif
