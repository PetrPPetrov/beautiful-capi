...
#ifndef RETURNVALUE_PRINTER_DECLARATION_INCLUDED
#define RETURNVALUE_PRINTER_DECLARATION_INCLUDED
...
public:
    inline Printer();
    inline void ShowFirstName(const ReturnValue::FirstName& first_name);
    inline void ShowMiddleName(const ReturnValue::MiddleNamePtr& middle_name);
    inline void ShowLastName(const ReturnValue::LastNameRawPtr& last_name);
...
#endif /* RETURNVALUE_PRINTER_DECLARATION_INCLUDED */
