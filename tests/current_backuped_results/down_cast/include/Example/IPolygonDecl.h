...
#ifndef EXAMPLE_IPOLYGON_DECLARATION_INCLUDED
#define EXAMPLE_IPOLYGON_DECLARATION_INCLUDED
...
public:
    ...
    inline IPolygonPtr* operator->();
    inline const IPolygonPtr* operator->() const;
protected:
...
#endif /* EXAMPLE_IPOLYGON_DECLARATION_INCLUDED */
