...
#ifndef BEAUTIFUL_CAPI_COPYSEMANTIC_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_COPYSEMANTIC_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_CopySemantic
{
...
#endif /* BEAUTIFUL_CAPI_COPYSEMANTIC_FORWARD_HOLDER_INCLUDED */
