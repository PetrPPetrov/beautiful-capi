...
int AutoGen_Internal_CopySemantic_ExampleGetMajorVersionImpl()
{
    return 1;
}

int AutoGen_Internal_CopySemantic_ExampleGetMinorVersionImpl()
{
    return 0;
}

int AutoGen_Internal_CopySemantic_ExampleGetPatchVersionImpl()
{
    return 0;
}
...
{
    return AutoGen_Internal_CopySemantic_ExampleGetMajorVersionImpl();
}

EXAMPLE_API int EXAMPLE_API_CONVENTION example_get_minor_version()
{
    return AutoGen_Internal_CopySemantic_ExampleGetMinorVersionImpl();
}

EXAMPLE_API int EXAMPLE_API_CONVENTION example_get_patch_version()
{
    return AutoGen_Internal_CopySemantic_ExampleGetPatchVersionImpl();
}
...
EXAMPLE_API void* EXAMPLE_API_CONVENTION example_dumper_get_printer_const(void* object_pointer)
{
    ...
    Example::PrinterImpl result_implementation_copy(self->GetPrinter());
    return new Example::PrinterImpl(result_implementation_copy);
}
