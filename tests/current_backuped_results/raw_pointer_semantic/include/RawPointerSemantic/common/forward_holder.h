...
#ifndef BEAUTIFUL_CAPI_RAWPOINTERSEMANTIC_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_RAWPOINTERSEMANTIC_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_RawPointerSemantic
{
...
#endif /* BEAUTIFUL_CAPI_RAWPOINTERSEMANTIC_FORWARD_HOLDER_INCLUDED */
