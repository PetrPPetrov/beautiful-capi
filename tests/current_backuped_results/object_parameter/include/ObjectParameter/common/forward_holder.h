...
#ifndef BEAUTIFUL_CAPI_OBJECTPARAMETER_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_OBJECTPARAMETER_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_ObjectParameter
{
...
#endif /* BEAUTIFUL_CAPI_OBJECTPARAMETER_FORWARD_HOLDER_INCLUDED */
