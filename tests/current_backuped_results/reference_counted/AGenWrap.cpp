...
int AutoGen_Internal_ReferenceCounted_ExampleGetMajorVersionImpl()
{
    return 1;
}

int AutoGen_Internal_ReferenceCounted_ExampleGetMinorVersionImpl()
{
    return 0;
}

int AutoGen_Internal_ReferenceCounted_ExampleGetPatchVersionImpl()
{
    return 0;
}
...
{
    return AutoGen_Internal_ReferenceCounted_ExampleGetMajorVersionImpl();
}

EXAMPLE_API int EXAMPLE_API_CONVENTION example_get_minor_version()
{
    return AutoGen_Internal_ReferenceCounted_ExampleGetMinorVersionImpl();
}

EXAMPLE_API int EXAMPLE_API_CONVENTION example_get_patch_version()
{
    return AutoGen_Internal_ReferenceCounted_ExampleGetPatchVersionImpl();
}
