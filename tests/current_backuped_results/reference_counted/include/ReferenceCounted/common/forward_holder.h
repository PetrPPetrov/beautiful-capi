...
#ifndef BEAUTIFUL_CAPI_REFERENCECOUNTED_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_REFERENCECOUNTED_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_ReferenceCounted
{
...
#endif /* BEAUTIFUL_CAPI_REFERENCECOUNTED_FORWARD_HOLDER_INCLUDED */
