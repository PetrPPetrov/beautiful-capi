...
#ifndef BEAUTIFUL_CAPI_VIRTUALINTERFACE_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_VIRTUALINTERFACE_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_VirtualInterface
{
...
#endif /* BEAUTIFUL_CAPI_VIRTUALINTERFACE_FORWARD_HOLDER_INCLUDED */
