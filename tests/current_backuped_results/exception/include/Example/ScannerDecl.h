...
#ifndef EXAMPLE_SCANNER_DECLARATION_INCLUDED
#define EXAMPLE_SCANNER_DECLARATION_INCLUDED
...
public:
    ...
    inline ScannerPtr* operator->();
    inline const ScannerPtr* operator->() const;
protected:
...
#endif /* EXAMPLE_SCANNER_DECLARATION_INCLUDED */
