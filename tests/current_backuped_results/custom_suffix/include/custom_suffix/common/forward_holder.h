...
#ifndef BEAUTIFUL_CAPI_CUSTOM_SUFFIX_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_CUSTOM_SUFFIX_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_custom_suffix
{
...
#endif /* BEAUTIFUL_CAPI_CUSTOM_SUFFIX_FORWARD_HOLDER_INCLUDED */
