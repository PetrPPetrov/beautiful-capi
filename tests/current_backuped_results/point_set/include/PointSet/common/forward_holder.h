...
#ifndef BEAUTIFUL_CAPI_POINTSET_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_POINTSET_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_PointSet
{
...
#endif /* BEAUTIFUL_CAPI_POINTSET_FORWARD_HOLDER_INCLUDED */
