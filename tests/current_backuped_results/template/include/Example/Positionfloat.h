...
{
    return example_position_float_get_x(this->get_raw_pointer());
}

inline void Example::Position<float>::SetX(float x)
{
    example_position_float_set_x(this->get_raw_pointer(), x);
}

inline float Example::Position<float>::GetY() const
{
    return example_position_float_get_y(this->get_raw_pointer());
}

inline void Example::Position<float>::SetY(float y)
{
    example_position_float_set_y(this->get_raw_pointer(), y);
}

inline float Example::Position<float>::GetZ() const
{
    return example_position_float_get_z(this->get_raw_pointer());
}

inline void Example::Position<float>::SetZ(float z)
{
    example_position_float_set_z(this->get_raw_pointer(), z);
}
...
inline void* Example::Position<float>::get_raw_pointer() const
{
    return mObject;
}
