...
#ifndef EXAMPLE_VECTOROF_EXAMPLE_VECTOROF_EXAMPLE_POSITION4D_FLOAT_DECLARATION_INCLUDED
#define EXAMPLE_VECTOROF_EXAMPLE_VECTOROF_EXAMPLE_POSITION4D_FLOAT_DECLARATION_INCLUDED
...
public:
    ...
    inline void Clear();
    inline void PushBack(const Example::VectorOf<Example::Position4D<float> >& value);
...
#endif /* EXAMPLE_VECTOROF_EXAMPLE_VECTOROF_EXAMPLE_POSITION4D_FLOAT_DECLARATION_INCLUDED */
