...
#ifndef EXAMPLE_VECTOROF_DOUBLE_DECLARATION_INCLUDED
#define EXAMPLE_VECTOROF_DOUBLE_DECLARATION_INCLUDED
...
public:
    ...
    #ifdef EXAMPLE_CPP_COMPILER_HAS_RVALUE_REFERENCES
    inline VectorOf<double>& operator=(VectorOf<double>&& other);
    #endif /* EXAMPLE_CPP_COMPILER_HAS_RVALUE_REFERENCES */
...
#endif /* EXAMPLE_VECTOROF_DOUBLE_DECLARATION_INCLUDED */
