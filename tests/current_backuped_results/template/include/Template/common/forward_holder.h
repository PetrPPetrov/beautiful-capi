...
#ifndef BEAUTIFUL_CAPI_TEMPLATE_FORWARD_HOLDER_INCLUDED
#define BEAUTIFUL_CAPI_TEMPLATE_FORWARD_HOLDER_INCLUDED

#ifdef __cplusplus

namespace beautiful_capi_Template
{
...
#endif /* BEAUTIFUL_CAPI_TEMPLATE_FORWARD_HOLDER_INCLUDED */
